...
# CONFIGURACIÓN“N DE LOS PARÁMETROS 
epsilon = 0.3
number_actions = 5
...
# Variables nuevas
early_stopping = True
patience_max = 50 # paciencia máxima, mayor número más margen pero más recursos
...
if (env.train):
    ...
    for epoch in range(1, number_epochs):
        ...
        while ((not game_over) and (timestep <= 5*30*24*60)):
            ...
            # ALMACENAR LA NUEVA TRANSACCIÓN EN LA MEMORIA
        ...
        # Parte de la eraly stopping
        if early_stopping:
            if (total_reward <= best_total_reward):
                # Tenemos menos paciencia
                patience_counter += 1
            else:
                # mejoramos resultado y recuperamos paciencia
